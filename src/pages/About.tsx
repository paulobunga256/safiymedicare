...
const doctors = [
  {
    ...
    description: 'Specializing in family medicine with over 15 years of experience.',
  },
  {
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-4">
                At VillageCare, our mission is to provide accessible, high-quality healthcare
                services to our community. We believe in treating each patient with dignity,
                respect, and personalized attention.
              </p>
              <p className="text-gray-600">
                Founded in 1995, we have grown to become a trusted healthcare provider,
                serving thousands of patients with comprehensive medical services.
              </p>
            </div>
            ...
            {doctors.map((doctor, index) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="text-sky-600 mb-3">{doctor.specialty}</p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
              ...
              >
                <div className="bg-sky-50 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 text-sky-600">
                  {value.icon}
                </div>
